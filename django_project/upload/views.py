...
import pandas as pd
from .algorithm import gps_distance_between_coordinates, searching_anomalies
...
def some_view(request):
    ...
    if request.method == "POST":
        ...
        # Checking whether distance between 2 places is no bigger
        # than plane's maximum distance
